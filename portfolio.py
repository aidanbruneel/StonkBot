...
class CryptoAsset(Asset):
    def __init__(self, symbol: str, quantity: float = 0.00):
        Asset.__init__(self, symbol, float(quantity))
        self.__type = 'crypto'

class StockAsset(Asset):
   def __init__(self, symbol: str, quantity: int = 0):
       Asset.__init__(self, symbol, int(quantity))
       self.__type = 'stock'
